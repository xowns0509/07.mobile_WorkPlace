...
<%
	...
	// 현재 페이지(정수) / 한 페이지 당 보여줄 페지 번호 수(정수) + (그룹 번호는 현제 페이지(정수) % 한페이지 당 보여줄 페지 번호 수(정수)>0 ? 1 : 0)
...
<hr />
<a href="test2.jsp?pageno=1">[맨앞으로]</a>
<a href="test2.jsp?pageno=<%=prev_pageno%>">[이전]</a>
<%
...
%><a href="test2.jsp?pageno=<%=next_pageno%>">[다음]</a>
<a href="test2.jsp?pageno=<%=total_page%>">[맨뒤로]</a>
