...
<body>
 ...
 확인되었습니다." /></h4>
  ...
  <!-- #######  리다이렉트 페이지 이동. 사용자의 페이지를 변환. 사용자에게 보여주고 싶은 페이지로   -->
<!--   의도적으로 모르게 다른화면으로 보여주기 위함 -->
  <%
  	response.sendRedirect("04_responseSecond.jsp");
  %>
  <!-- 클라 > 서버에게 04_responseFirst.jsp를 요청하겠지. -->
  <!-- 그러면 원래는 서버는 클라에게 04_responseFirst.jsp를 주지만 -->
  <!-- 이 04_responseSecond.jsp를 다시 요청하게 됨. -->
  <!-- 그럼 서버는 04_responseSecond.jsp를 다시 주게 됨. -->

  <!-- 문제는 속도가 느리면 사용자가 04_responseFirst를 보게 될 수도 있게된단 말이지. -->
